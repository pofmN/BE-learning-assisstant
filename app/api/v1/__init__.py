...
from app.api.v1 import auth, document, course, flashcard, progress, quiz, studies_note, conversation, review_quiz, user, sharing_course, folder
...
api_router.include_router(folder.router, prefix="/folder", tags=["Folder Management"])
api_router.include_router(sharing_course.router, prefix="/course-sharing", tags=["Course Sharing"])
...
api_router.include_router(user.router, prefix="/user", tags=["User ProfileManagement"])